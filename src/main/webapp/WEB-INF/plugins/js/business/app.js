...
define(["../common_metronic", "cus"], function (p) {
    require(["menu-sidebar", "quick-nav", "quick-sidebar", "LG", "layout", "bootstrap_tab_close", "message"], function (a) {
        $("#maingrid").ligerGrid({
            columns: [
        ...
        $('#menu2').sidebarMenu({
            data: [{
                id: '1',
                text: '基础系统设置' + messages_bundle_js['common.menu.text'],
                icon: 'icon-wrench',
                url: '',
                menus: [{
                    id: '11',
                ...
                menus: [{
                    ...
                    text: '用户车牌',
                    icon: 'icon-moustache',
                    url: '../customercar/list'
                }, {
                    id: '23',
                    text: '用户购买车位',
                    icon: 'icon-magnet',
                    url: '../customerpurchaselog/list'
                }, {
                    id: '24',
                    text: '用户停车状态',
                    icon: 'icon-list',
                    url: '../machineparking/parkStatusList'
                }]
            }]
        });
    });
